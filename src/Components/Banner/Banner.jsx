...
function Banner() {
  return (
    <section data-aos="fade-up" className="min-h-96 bg-[#455E86] text-white rounded-4xl mx-4 my-2 px-12 md:px-28 py-4 flex flex-col md:flex-row items-center justify-between">
      {/* Left Content */}
