...
function Banner() {
  return (
    <section
      data-aos="fade-up"
      className="min-h-96 bg-[#455E86] text-white rounded-4xl mx-6 my-2 px-12 md:px-24 flex flex-col md:flex-row items-center justify-between"
    >
      {/* Left Content */}
      <div className="flex-1 text-center md:text-left space-y-2">
        ...
        <p className="text-xl font-sora font-medium text-white bg-gradient-to-r from-[#455E86] to-[#63A8ED] pr-8 py-2 my-4 rounded-full inline-block">
